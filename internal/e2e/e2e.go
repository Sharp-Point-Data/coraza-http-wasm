...
// Vendored from github.com/corazawaf/coraza/v3@v3.3.3 http/e2e.
// Coraza v3.4.0+ added an SSE streaming test case to this suite that a
// response-buffering connector (http-wasm requires FeatureBufferResponse)
// can never satisfy, so we pin the connector-applicable checks here.
